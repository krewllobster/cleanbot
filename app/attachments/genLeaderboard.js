...
const genLeaderBoard = async (throwdown_id) => {
  ...
  const tdData = await Throwdown.findOne({_id: throwdown_id}, {questions: 0})
  ...
  const headers = ['user', 'r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9', 'r10', 'total']
  const flatLeaderBoardData = [headers,
